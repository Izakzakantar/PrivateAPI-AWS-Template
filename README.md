...
<!-- TODO: the image above does not exist yet. Claude Code cannot generate
     a diagram image file -- add your own architecture-diagram.png under
     docs/ (see docs/README.md for what it should depict), then remove
     this comment. -->
